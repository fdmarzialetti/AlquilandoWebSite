...
public class DBRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        userRepository.save(new AppUser("Martin","Sar","000021000","","martinesquercia99@gmail.com", passwordEncoder.encode("123456"), UserRol.CLIENT));
        userRepository.save(new AppUser("Emiliano","Sar","000022000","","a@gmail.com", passwordEncoder.encode("123456"), UserRol.CLIENT));
